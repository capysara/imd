...
class DrupaleasyRepositoriesServiceTest extends KernelTestBase {
  ...
  protected static $modules = [
    ...
    // Node, field, user, & system are common if doing something with nodes.
    'node',
    'field',
    'user',
    'system',
  ...
  protected function setUp(): void {
    ...
    // Part of Kernel test base. Installs the schema (db structure) for the
    // specified module.
  ...
  public function provideTestIsUnique(): array {
    ...
    // This return is the bool and array in the function testIsUnique.
    return [
  ...
  public function testIsUnique(bool $expected, array $repo): void {
    ...
    // Variable is "reflection" and the method $reflection_is_unique.
    $reflection_is_unique = new \ReflectionMethod($this->drupaleasyRepositoriesService, 'isUnique');
    // Now we can make our changes to the method. SetAccessible TRUE basically
    // makes it a public method instead of protected.
    $reflection_is_unique->setAccessible(TRUE);
    $actual = $reflection_is_unique->invokeArgs(
      // Call the method on the service and pass it 2 arguments [$repo, 999].
