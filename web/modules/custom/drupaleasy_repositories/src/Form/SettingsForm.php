...
class SettingsForm extends ConfigFormBase {
  ...
  public static function create(ContainerInterface $container): self {
    // Whatever is in the __construct, needs to be included here.
    return new static($container->get('config.factory'), $container->get('plugin.manager.drupaleasy_repositories'),);
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state): array {
    ...
    // Need to inject plugin manager service into this class.
    ...
    foreach ($repositories as $repository => $definition) {
      // Key is $repository_options[$repository].
      // Value is $definition['label'].
